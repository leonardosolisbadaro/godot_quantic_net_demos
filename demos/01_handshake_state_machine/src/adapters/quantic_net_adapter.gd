...
func get_current_state_name() -> String:
	match _session.current_state:
		NetworkSession.State.DISCONNECTED: return "DISCONNECTED"
		NetworkSession.State.CONNECTING: return "CONNECTING"
		NetworkSession.State.CONNECTED: return "CONNECTED"
		NetworkSession.State.FAILED: return "FAILED"
		_: return "UNKNOWN"
