...
- [ ] **03_entity_registry_authoritative_spawning:** Entity Registry & Profiles (Sincronização de peers, instanciamento autoritativo e perfis dinâmicos de Tick Rate / Prioridade via `QNEntityProfile`)
- [ ] **04_client_side_prediction_kinematics:** Client-Side Prediction (CSP) & Kinematics (Responsividade instantânea e movimentação sem lag local)
- [ ] **05_snapshot_interpolation:** Snapshot Interpolation (O fim do Jitter visual via Lerping fluido)
